...
import { MultistyleText, MultistyleTextSettings } from './MultistyleText';
import { Number } from './Number';
import { Boolean } from './Boolean';
import { Image, ImageSettings } from './Image';
import { ImageGallery, ImageGallerySettings } from './ImageGallery';
import { Video, VideoSettings } from './Video';
import { Color } from './Color';
import { Option } from './Option';
import { File, FileSettings } from './File';
...
export const RECORD_FIELD_SETTINGS = {
  [MODEL_FIELD_TYPES.MULTISTYLE_TEXT]: MultistyleTextSettings,
  [MODEL_FIELD_TYPES.IMAGE]: ImageSettings,
  [MODEL_FIELD_TYPES.IMAGES_GALLERY]: ImageGallerySettings,
  [MODEL_FIELD_TYPES.VIDEO]: VideoSettings,
  [MODEL_FIELD_TYPES.FILE]: FileSettings,
};
