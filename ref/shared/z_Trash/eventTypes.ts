// // Unified event type definitions / Единые определения типов событий
// // Enum for application event types. Used in both EventBus and entities/event / Enum для типов событий в приложении. Используется как в EventBus, так и в entities/event
...
//   UI_ACTIVITY_CLICKED = 'ui.activity.clicked',
// }
